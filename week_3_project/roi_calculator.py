...
def roi_calc():
    running = True
    values = {"total_income": 0, "total_expenses": 0, "initial_investment": 0}
    while running == True:
        ...
        try:    
            ...
            match choice:
                case 0:
                    running = False
                case 1:
                    values['total_income'] = get_income()
                case 2:
                    values['total_expenses'] = get_expenses()
                case 3:
                    values['initial_investment'] = get_investment()
                case 4:
                    values['total_income'], values['total_expenses'], values['initial_investment'] = 0,0,0
                case _:
